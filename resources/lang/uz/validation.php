...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'phone_home'            => 'Uy telefoni',
        'image'                 => 'Rasm',
        'passport_seria'        => 'Pasport seria',
        'passport_image'        => 'Pasport nusxasi',
        'passport_number'       => 'Pasport raqam',
        'passport_jshshir'      => 'Pasport jshshir',
        'passport_given_by'     => 'Kim tomonidan berilgan',
        'passport_issued_date'  => 'Pasport berilgan sana',
        'passport_expiration_date' => 'Pasport amal qilish muddati',
        'diplom_seria'          => 'Diplom seriasi',
        'diplom_number'         => 'Diplom raqami',
        'diplom_copy'           => 'Diplom nusxasi',
        'diplom_ilova_copy'     => 'Diplom ilova nusxasi',
        'diplom_issued_date'    => 'Diplom berilgan sana',
        'specialization'        => 'Mutaxasislik',
        'specialization_code'   => 'Mutaxasislik shifri',
    ],
];
