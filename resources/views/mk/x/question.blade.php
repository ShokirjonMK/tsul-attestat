        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-7 col-sm-12">
                    <h5>ID: {{ $department->id}} ({{ $department->name }})</h5>
                    Tur bo'yicha taqsimoti:
                    @isset($department->json_question_count)
                    @php $json_question = json_decode($department->json_question_count); @endphp
                    @foreach($json_question as $type => $count)
                    <span style="border: blue 2px solid; margin-right: 3px; "> {{ $type}} - turdan {{ $count }} tadan savol </span>
                    @endforeach
                    @endisset
                </div>
                <div class="col-md-3 col-sm-12 text-right"
                     style="    display: flex;justify-content: flex-end; align-items: center;">
                    <span class="close mr-5" style="font-size: 18px; "> <a href="{{ asset('shablon.xlsx') }}">
                ...
                <table class="table hover data-table-export ">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="p-1" onclick="mk_conform()" href="{{route('xquestiondel', $item->id)}}"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pd-0">
                <div class="task-list-form">
                    <ul>
                        <li>
                            <form autocomplete="off" id="mk_form_add_dep" action="{{ route('xexcelupload') }}"
