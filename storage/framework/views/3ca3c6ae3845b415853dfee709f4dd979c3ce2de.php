        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12 text-right"
                    ...
                    <span class="close mr-5" style="font-size: 18px; "> <a href="<?php echo e(asset('shablon1.xlsx')); ?>">
                ...
                <table class="table hover data-table-export ">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="p-1" onclick="mk_conform()" href="<?php echo e(route('maindel', $item->id)); ?>"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pd-0">
                <div class="task-list-form">
                    <ul>
                        <li>
                            <form autocomplete="off" id="mk_form_add_dep" action="<?php echo e(route('mainupload')); ?>"
...
<?php echo $__env->make('mk.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/attestat/resources/views/mk/x/main.blade.php ENDPATH**/ ?>