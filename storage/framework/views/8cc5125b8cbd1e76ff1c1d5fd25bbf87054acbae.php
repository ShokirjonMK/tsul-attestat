...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('assets/tsul.png')); ?>">
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('assets/tsul.png')); ?>">
...
<body>
	...
	<?php echo $__env->yieldContent('content'); ?>
	 ...
	 <div class="footer-wrap pd-20 mb-20 card-box " style="border-radius: 0px; position: sticky; top: 90vh; ">
		 <a style="text-decoration: none;" href="#" target="_blank">TOSHKENT DAVLAT YURIDIK UNIVERSITETI <br> 
		 	"ELEKTRON UNIVERSITET" MARKAZI
		 </a>
...
</html><?php /**PATH /var/www/attestat/resources/views/mk/layouts/master.blade.php ENDPATH**/ ?>